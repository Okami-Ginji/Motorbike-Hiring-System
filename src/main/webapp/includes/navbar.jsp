        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a style="font-size: large;" href="contact.jsp" class="nav-link">Liên hệ</a></li>
                    ...
                    <li class="nav-item"><a style="font-size: large;" href="login.jsp" class="nav-link">Đăng nhập</a></li>
                    </c:if>
                    <c:if test="${sessionScope.account != null}">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" id="myDropdown">
                            ...
                            <a class="dropdown-item" href="bookingHistory?status=all">Quản lý đặt hàng</a>
