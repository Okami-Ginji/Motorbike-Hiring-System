    ...
    <head>
        ...
        <style>
            ...
            .button-container {
                ...
                height: 5rem;            /*Full viewport height */
                /*background: #f0f4f8;      Light background to make the button pop 
            }
            ...
            /* Base styles for the button */
                .rent-now-btn {
                    ...
                    color: #fff;
                    padding: 16px 32px; /* Increased padding for better visibility */
                    border: none;
                                        ...
                                        <div class="media-body py-md-1">
                                            ...
                                            <div class="text">
                                                <h3 style="margin-top: -17px;
                                                    ;" class="heading mb-0 pl-3 text-left">
