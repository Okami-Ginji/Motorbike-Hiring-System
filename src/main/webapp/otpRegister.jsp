                    ...
                    <form class="rounded bg-white shadow p-5" action="otp" method="post">
                        ...
                        <div class="otp_input text-start mb-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-2">
                                ...
                                <input type="text" class="form-control" maxlength="1" name="input2">
                                <input type="text" class="form-control" maxlength="1" name="input3">
                                <input type="text" class="form-control" maxlength="1" name="input4">
                                <input type="text" class="form-control" maxlength="1" name="input5">
                                <input type="text" class="form-control" maxlength="1" name="input6">
                            </div> 
                        </div>  
